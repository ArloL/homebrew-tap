class MenubarScripts < Formula
  ...
  url "https://github.com/ArloL/menubar-scripts/archive/refs/tags/v2603.0.102.tar.gz"
  sha256 "b7d60df252430679a54f90eee113e4cd6110068368f5e42c76a0bbfbceef2b9f"
  license "MIT"
